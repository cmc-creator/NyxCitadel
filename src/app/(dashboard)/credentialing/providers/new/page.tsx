...
export default function NewProviderPage() {
  ...
  return (
    <div className="max-w-2xl space-y-6">
      <div>
        <a href="/credentialing/providers" className="inline-flex items-center gap-1 text-sm text-muted-foreground hover:text-teal-600 mb-3">
        ...
        <p className="text-sm text-muted-foreground mt-0.5">Initial appointment or new credentialing application.</p>
      </div>
