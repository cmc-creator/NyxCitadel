...
export default function EditProviderPage() {
  ...
  return (
    <div className="max-w-2xl space-y-6">
      <div>
        <a href={`/credentialing/providers/${id}`} className="inline-flex items-center gap-1 text-sm text-muted-foreground hover:text-purple-600 mb-3">
        ...
        <p className="text-sm text-muted-foreground mt-0.5">Update provider credentials and appointment information.</p>
      </div>
      ...
      <form key={data.id} onSubmit={handleSubmit} className="bg-card rounded-xl border border-border divide-y divide-border/30">
        <div className="px-6 py-5 space-y-4">
          ...
          <div className="grid grid-cols-3 gap-4">
            <div>
              <label className="block text-xs font-medium text-muted-foreground mb-1">Credentials *</label>
              <input name="credentials" required className="form-input w-full"
                defaultValue={data.credentials ?? ''} placeholder="MD, DO, APRN…" />
            </div>
            <div className="col-span-2">
              <label className="block text-xs font-medium text-muted-foreground mb-1">NPI Number</label>
        ...
        <div className="px-6 py-5 space-y-4">
          ...
          <div className="grid grid-cols-2 gap-4">
            <div>
              <label className="block text-xs font-medium text-muted-foreground mb-1">Provider Type *</label>
        ...
        <div className="px-6 py-5 space-y-4">
          ...
          <div className="grid grid-cols-2 gap-4">
            <div>
              <label className="block text-xs font-medium text-muted-foreground mb-1">Initial Appointment Date</label>
            ...
            <div>
              <label className="block text-xs font-medium text-muted-foreground mb-1">Reappointment Date</label>
        ...
        <div className="px-6 py-4 flex justify-end gap-3">
          <a href={`/credentialing/providers/${id}`} className="px-4 py-2 text-sm text-muted-foreground hover:text-foreground">Cancel</a>
