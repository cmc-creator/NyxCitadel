...
export default function NewOppeRecordPage() {
  ...
  return (
    <div className="max-w-2xl space-y-6">
      <div>
        <a href="/credentialing/oppe" className="inline-flex items-center gap-1 text-sm text-muted-foreground hover:text-teal-600 mb-3">
        ...
        <p className="text-sm text-muted-foreground mt-0.5">Ongoing Professional Practice Evaluation - TJC MS.08.01.01. Metrics can be added after creation.</p>
      </div>
      ...
      <form onSubmit={handleSubmit} className="bg-card rounded-xl border border-border divide-y divide-border/30">
        <div className="px-6 py-5 space-y-4">
          ...
          <div className="grid grid-cols-3 gap-4">
            ...
            <div>
              <label className="block text-xs font-medium text-muted-foreground mb-1">Review Cycle Label *</label>
        ...
        <div className="px-6 py-5 space-y-4">
          ...
          <div className="grid grid-cols-3 gap-4">
            <div>
              <label className="block text-xs font-medium text-muted-foreground mb-1">Total Cases Reviewed</label>
              <input name="totalCases" type="number" min="0" defaultValue="0" className="form-input w-full" />
            </div>
            <div>
              <label className="block text-xs font-medium text-muted-foreground mb-1">Compliant Cases</label>
              <input name="compliantCases" type="number" min="0" defaultValue="0" className="form-input w-full" />
            </div>
            <div>
              <label className="block text-xs font-medium text-muted-foreground mb-1">Overall Rating *</label>
        ...
        <div className="px-6 py-4 flex justify-end gap-3">
          <a href="/credentialing/oppe" className="px-4 py-2 text-sm rounded-lg border border-border text-muted-foreground hover:bg-accent/50">Cancel</a>
