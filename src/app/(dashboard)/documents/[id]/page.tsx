  ...
  return (
    <div className="space-y-6 max-w-3xl">
      ...
      <div className="bg-card border border-border rounded-xl p-6">
        <div className="flex items-start justify-between gap-4">
          ...
          <div className="flex items-center gap-2 flex-shrink-0">
            ...
            <button
              ...
              disabled={deleting}
              className="inline-flex items-center gap-1.5 border border-red-200 text-red-500 hover:bg-red-950/20 text-sm font-medium px-3 py-1.5 rounded-lg transition disabled:opacity-50"
            >
        ...
        {/* Expiry warnings */}
        {isExpired && (
          <div className="mt-4 flex items-center gap-2 bg-red-950/20 border border-red-200 rounded-lg px-4 py-2.5">
        ...
        {expiresWithin30 && (
          <div className="mt-4 flex items-center gap-2 bg-amber-950/20 border border-amber-200 rounded-lg px-4 py-2.5">
      ...
      {doc.tags.length > 0 && (
        <div className="bg-card border border-border rounded-xl px-5 py-4">
          <div className="flex items-center gap-2 mb-3">
            ...
            <span className="text-sm font-semibold text-foreground/80">Tags</span>
          </div>
      ...
      <div className="bg-card border border-border rounded-xl px-5 py-4 flex items-center justify-between gap-4">
        <div>
          <p className="text-sm font-semibold text-foreground/80">File Location</p>
          <p className="text-xs text-muted-foreground/70 mt-0.5 break-all">{doc.fileUrl}</p>
        </div>
        <a
          href={doc.fileUrl}
          target="_blank"
