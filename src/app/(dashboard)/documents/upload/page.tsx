    ...
    <div className="max-w-2xl space-y-6">
      ...
      <form onSubmit={handleSubmit} className="bg-card rounded-xl border border-border p-6 space-y-5">
        ...
        <div className="flex gap-3 pt-2">
          ...
          <Link href="/documents" className="px-4 py-2.5 text-sm font-medium text-muted-foreground border border-border rounded-lg hover:bg-accent/50 transition-colors">
            Cancel
          </Link>
        </div>
      </form>

      <div className="bg-blue-950/20 border border-blue-200 rounded-xl px-4 py-3">
