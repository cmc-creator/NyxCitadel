...
import { HeartHandshake, ChevronRight, CheckCircle, AlertTriangle, FileText, Shield, Clock } from 'lucide-react';
...
const subModules = [
  ...
  },
  {
    ...
    icon: '📋',
    badge: 'CMS §482.13(b)(3)',
    badgeColor: 'bg-emerald-100 text-emerald-700',
    stat: 'All current admissions documented',
  ...
  return (
    <div className="p-6 space-y-6">
      ...
      <div className="grid grid-cols-2 lg:grid-cols-4 gap-4">
        {[
          { label: 'Active Admissions', value: 24, icon: HeartHandshake, color: 'text-rose-400' },
          { label: 'Active Holds', value: 5, icon: Shield, color: 'text-amber-400' },
          { label: 'Rights Issues', value: gaps, icon: AlertTriangle, color: gaps > 0 ? 'text-amber-400' : 'text-emerald-400' },
          { label: 'Consents Current', value: '100%', icon: CheckCircle, color: 'text-emerald-400' },
        ].map(s => (
