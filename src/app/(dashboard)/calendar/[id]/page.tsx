  ...
  return (
    <div className="max-w-3xl space-y-6">
      ...
      <div className="flex items-center justify-between gap-2">
        ...
        <Link href={`/calendar/${id}/edit`} className="inline-flex items-center gap-1.5 px-3 py-1.5 text-sm bg-slate-100 hover:bg-slate-200 text-slate-700 rounded-lg font-medium transition-colors">
