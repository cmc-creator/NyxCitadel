...
export default function EditIrIadPage() {
  ...
  return (
    <div className="max-w-3xl mx-auto space-y-6">
      <div>
        <a href={`/trackers/ir-iad/${id}`} className="inline-flex items-center gap-1 text-sm text-slate-500 hover:text-foreground/80 mb-3">
      ...
      <form key={data.id} onSubmit={handleSubmit} className="space-y-6">
        ...
        <div className="flex gap-3 pb-8">
          ...
          <a href={`/trackers/ir-iad/${id}`} className="px-4 py-2.5 text-sm text-slate-600 hover:text-foreground rounded-lg border border-slate-300 hover:border-slate-400 transition-colors">
            Cancel
          </a>
        </div>
      </form>
