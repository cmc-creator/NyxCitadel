...
export default function EditSurveyPage() {
  ...
  return (
    <div className="max-w-2xl space-y-6">
      <div>
        <a href={`/surveys/${id}`} className="inline-flex items-center gap-1 text-sm text-slate-500 hover:text-teal-500 mb-3">
      ...
      <form key={data.id} onSubmit={handleSubmit} className="bg-card rounded-xl border border-border divide-y divide-border/30">
        ...
        <div className="px-6 py-4 flex items-center justify-end gap-3">
          <a href={`/surveys/${id}`} className="px-4 py-2 text-sm text-slate-600 hover:text-foreground">Cancel</a>
