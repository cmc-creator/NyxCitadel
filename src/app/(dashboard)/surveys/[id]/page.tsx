...
import { ClipboardList, ArrowLeft, AlertTriangle, CheckCircle2, Clock, ShieldCheck } from 'lucide-react';
...
export default async function SurveyDetailPage({ params }: { params: { id: string } }) {
  ...
  return (
    <div className="max-w-3xl space-y-6">
      {/* Header */}
      <div>
        <Link href="/surveys" className="inline-flex items-center gap-1 text-sm text-slate-500 hover:text-purple-600 mb-3">
