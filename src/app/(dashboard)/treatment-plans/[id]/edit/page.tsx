...
export default function EditTreatmentPlanPage() {
  ...
  return (
    <div className="max-w-2xl space-y-6">
      <div>
        <a href={`/treatment-plans/${id}`} className="inline-flex items-center gap-1 text-sm text-slate-500 hover:text-teal-500 mb-3">
      ...
      <form key={data.id} onSubmit={handleSubmit} className="bg-card rounded-xl border border-border divide-y divide-border/30">
        ...
        <div className="px-6 py-5 space-y-4">
          <h2 className="text-sm font-semibold text-foreground">Patient Participation &amp; Goals</h2>
