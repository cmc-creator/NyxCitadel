...
export default function NewHandHygieneAuditPage() {
  ...
  return (
    <div className="max-w-2xl space-y-6">
      <div>
        <a href="/infection-control/hand-hygiene" className="inline-flex items-center gap-1 text-sm text-muted-foreground hover:text-teal-600 mb-3">
        ...
        <p className="text-sm text-muted-foreground mt-0.5">Compliance rate is calculated automatically from opportunities and compliant moments.</p>
      </div>
      ...
      <form onSubmit={handleSubmit} className="bg-card rounded-xl border border-border divide-y divide-border/30">
        <div className="px-6 py-5 space-y-4">
          <h2 className="text-sm font-semibold text-foreground">Audit Details</h2>
          <div className="grid grid-cols-2 gap-4">
            ...
            <div>
              <label className="block text-xs font-medium text-muted-foreground mb-1">Staff Type</label>
          ...
          <div className="grid grid-cols-2 gap-4">
            <div>
              <label className="block text-xs font-medium text-muted-foreground mb-1">Unit / Area *</label>
        ...
        <div className="px-6 py-5 space-y-4">
          ...
          <div className="grid grid-cols-3 gap-4 items-end">
            <div>
              <label className="block text-xs font-medium text-muted-foreground mb-1">Opportunities *</label>
              <input
            ...
            <div>
              <label className="block text-xs font-medium text-muted-foreground mb-1">Compliant Moments *</label>
              <input
        ...
        <div className="px-6 py-4 flex justify-end gap-3">
          <a href="/infection-control/hand-hygiene" className="px-4 py-2 text-sm rounded-lg border border-border text-muted-foreground hover:bg-muted/20">Cancel</a>
