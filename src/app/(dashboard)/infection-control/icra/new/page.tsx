...
export default function NewIcraPage() {
  ...
  return (
    <div className="max-w-2xl space-y-6">
      <div>
        <a href="/infection-control/icra" className="inline-flex items-center gap-1 text-sm text-muted-foreground hover:text-teal-600 mb-3">
        ...
        <p className="text-sm text-muted-foreground mt-0.5">Create the annual infection control risk assessment. Risk areas and goals are added after creation.</p>
      </div>
      ...
      <form onSubmit={handleSubmit} className="bg-card rounded-xl border border-border divide-y divide-border/30">
        ...
        <div className="px-6 py-4 flex justify-end gap-3">
          <a href="/infection-control/icra" className="px-4 py-2 text-sm rounded-lg border border-border text-muted-foreground hover:bg-muted/20">Cancel</a>
