...
export default function EditResponsePage() {
  ...
  return (
    <div className="max-w-4xl space-y-6">
      <div>
        <a href={`/quality/responses/${id}`} className="inline-flex items-center gap-1 text-sm text-muted-foreground hover:text-purple-600 mb-3">
        ...
        <div className="bg-card rounded-xl border border-border p-6 space-y-4">
          ...
          <div>
            ...
            <textarea
              ...
              required
              rows={20}
              className="w-full rounded-lg border border-border px-3 py-2.5 text-sm font-mono focus:outline-none focus:ring-2 focus:ring-purple-500 resize-y h-80"
            />
          </div>
        </div>
