...
export default function NewResponseTemplatePage() {
  ...
  return (
    <div className="max-w-3xl space-y-6">
      <div>
        <a href="/quality/response-templates" className="inline-flex items-center gap-1 text-sm text-muted-foreground hover:text-teal-600 mb-3">
        ...
        <p className="text-sm text-muted-foreground mt-0.5">
          Create a reusable template with variable placeholders like <code className="text-teal-600 bg-teal-950/20 px-1 rounded">{'{{PATIENT_NAME}}'}</code>.
        </p>
      </div>
      ...
      <form onSubmit={handleSubmit} className="space-y-5">
        ...
        <div className="bg-card rounded-xl border border-border p-6 space-y-4">
          ...
          <div className="flex flex-wrap gap-2">
            {variables.map(v => (
              <span key={v} className="inline-flex items-center gap-1 bg-teal-950/20 text-teal-300 border border-teal-800/50 text-xs px-2 py-1 rounded-full">
                {v}
          ...
          <div className="flex gap-2">
            ...
            <button
              ...
              className="inline-flex items-center gap-1 text-sm font-medium bg-muted/30 hover:bg-accent/50 text-foreground/80 px-3 py-2 rounded-lg"
            >
