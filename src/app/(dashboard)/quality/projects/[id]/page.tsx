...
const CATEGORY_COLORS: Record<string, string> = {
  ...
  STAFF_SAFETY:         'bg-teal-50 text-teal-700',
    ...
    <div className="space-y-6 max-w-4xl">
      ...
      <div>
        ...
        <div className="flex items-start justify-between gap-4 flex-wrap">
          <div className="flex items-center gap-3 flex-wrap">
            <Target className="w-6 h-6 text-teal-500 flex-shrink-0" />
            <div>
            ...
            <div className="bg-card rounded-xl border border-border p-4">
              ...
              <dl className="space-y-3 text-sm">
                ...
                <div>
                  ...
                  <dd className="text-2xl font-bold text-teal-600 mt-0.5">
      ...
      <div className="flex gap-3">
        <Link
          ...
          className="inline-flex items-center gap-1.5 text-sm font-medium text-teal-700 bg-teal-50 border border-teal-200 px-3 py-2 rounded-lg hover:bg-teal-100"
        >
          + New QAPI Project
        </Link>
        <Link
