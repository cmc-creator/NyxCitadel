...
export default function EditEocRoundPage() {
  ...
  return (
    <div className="max-w-2xl space-y-6">
      <div>
        <a href={`/eoc/rounds/${id}`} className="inline-flex items-center gap-1 text-sm text-muted-foreground hover:text-purple-600 mb-3">
      ...
      <form key={data.id} onSubmit={handleSubmit} className="bg-card rounded-xl border border-border divide-y divide-border/30">
        ...
        <div className="px-6 py-4 flex justify-end gap-3">
          <a href={`/eoc/rounds/${id}`} className="px-4 py-2 text-sm rounded-lg border border-border text-muted-foreground hover:bg-accent/50">Cancel</a>
