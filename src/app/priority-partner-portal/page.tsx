          ...
          <div className="flex items-start gap-3">
            ...
            <div>
              ...
              <div className="mt-4">
                <Link
                  href="/signup"
                  className="inline-flex items-center gap-2 rounded-xl bg-white text-slate-900 px-4 py-2.5 text-sm font-semibold hover:bg-slate-100 transition"
                >
