    ...
    <div className="min-h-screen bg-background text-white">
      <div className="max-w-6xl mx-auto px-6 py-16">
        <div className="max-w-3xl">
          <div className="inline-flex items-center gap-2 rounded-full border border-teal-500/30 bg-teal-500/10 px-3 py-1.5 text-xs font-semibold text-indigo-200 mb-6">
        ...
        <div className="mt-12 grid gap-5">
          {stops.map(({ title, body, href, icon: Icon }) => (
            <Link key={title} href={href} className="group rounded-2xl border border-border bg-card/50 p-6 hover:bg-card transition">
              <div className="grid md:grid-cols-[auto_1fr_auto] gap-4 items-start">
                ...
                <div>
                  ...
                  <p className="mt-2 text-sm text-foreground/70 leading-relaxed max-w-3xl">{body}</p>
                </div>
